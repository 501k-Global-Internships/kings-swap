  ...
  const handleContinue = async () => {
    ...
    try {
      const createTransaction = await apiService.transactions.createTransaction(
        { espee_amount : transactionData.amount, currency: transactionData.selectedCurrency, account_number: control._formValues.accountNumber, bank_id: control._formValues.bankId }
      ); 
