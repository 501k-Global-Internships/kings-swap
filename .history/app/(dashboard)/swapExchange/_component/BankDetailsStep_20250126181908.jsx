    ...
    <div>
      ...
      <div className="py-5 text-[1rem] mb-7 pl-14 bg-white rounded-lg border">
        <p className=" mb-4 text-gray-700">
          Total amount payable in Espees: <strong>10.5 Espee(s)</strong>
        </p>
        <p className=" text-gray-700">
          Amount to receive in Naira :<strong> ₦16500.0 </strong>
        </p>
      </div>
            ...
            render={({ field }) => (
              <div>
                ...
                <div className="relative">
                  ...
                  <ChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray- pointer-events-none" />
                </div>
                {errors.bankId && (
                  <p className="text-red-500 text-sm mt-1">
