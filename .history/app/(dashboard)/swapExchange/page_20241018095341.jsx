          ...
          <div className="bg-white p-6 rounded-lg shadow-sm max-w-md mx-auto">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex">
                  <input
                    type="text"
                    defaultValue="10.05"
                    className="w-full p-3 border border-gray-300 rounded-l focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
              ...
              <div className="relative">
                ...
                {showDropdown && (
                  <div className="absolute right-0 mt-1 w-32 bg-gray-600 text-white border rounded shadow-lg z-10">
                    {currencies.map((curr) => (
                      <div
                        key={curr}
                        onClick={() => {
        ...
        return (
          <div className="bg-white p-3 rounded-lg shadow-sm max-w-md mx-auto">
            <div className="mb-3">
              ...
              <p className="text-sm text-gray-600 mt-2 whitespace-nowrap">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <select className="w-full p-3 border border-gray-300 rounded appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
