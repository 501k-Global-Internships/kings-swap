    ...
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <Link href='/loginPage' className="w-full border border-gray-300 text-gray-700 py-2 px-4 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 mb-4">
            Go to Login
          </Link>
        </div>
      </div>
